...
namespace DualNumbers.Test
{
    ...
    public class TDualOperators
    {
        ...
        */
        ...
        [TestCase(double.PositiveInfinity, 1, 0, 0, double.PositiveInfinity, 1)]
        [TestCase(1, double.PositiveInfinity, 0, 0, double.NegativeInfinity, -1)]
        [TestCase(1, 0, double.PositiveInfinity, 0, double.NegativeInfinity, 0)]
        [TestCase(1, 0, 0, double.PositiveInfinity, double.NegativeInfinity, 0)]
        public void SubtractionWithInfinity(double leftReal, double leftDual, double rightReal, double rightDual, double expectedReal, double expectedDual)
        {
            var left = new Dual(leftReal, leftDual);
            var right = new Dual(rightReal, rightDual);
            var expected = new Dual(expectedReal, expectedDual);
        ...
        */
        ...
        [TestCase(double.PositiveInfinity, 1, 0, 0, double.NaN, 0)]
        [TestCase(1, double.PositiveInfinity, 0, 0, 0, double.PositiveInfinity)]
        [TestCase(1, 0, double.PositiveInfinity, 0, double.PositiveInfinity, 0)]
        [TestCase(1, 0, 0, double.PositiveInfinity, double.PositiveInfinity, double.NaN)]
        ...
        */
        ...
        [TestCase(double.PositiveInfinity, 1, 0, 0, double.PositiveInfinity, 1)]
        [TestCase(1, double.PositiveInfinity, 0, 0, 0, 0)]
        [TestCase(1, 0, double.PositiveInfinity, 0, double.PositiveInfinity, 0)]
        [TestCase(1, 0, 0, double.PositiveInfinity, 0, 0)]
        ...
        */
        ...
        [TestCase(double.MaxValue, 1.0, 2.0, 1.0, double.PositiveInfinity, double.PositiveInfinity)]
        [TestCase(-double.MaxValue, 1.0, -2.0, 1.0, double.NegativeInfinity, double.NegativeInfinity)]
        ...
        [TestCase(double.MinValue, 1.0, -2.0, 1.0, double.NegativeInfinity, double.NegativeInfinity)]
        ...
        [TestCase(double.MinValue, 1.0, double.MaxValue, 1.0, 0.0, 0.0)]
        [TestCase(double.MaxValue, 1.0, double.MinValue, 1.0, double.NegativeInfinity, double.PositiveInfinity)]
        ...
        [TestCase(double.MinValue, 1.0, 0.0000000001, 1.0, 0.0, 0.0)]
        [TestCase(-double.MaxValue, 1.0, 0.0000000001, 1.0, -0.0, 0.0)]
